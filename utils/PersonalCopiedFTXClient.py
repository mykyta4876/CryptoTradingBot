...
class FtxClient:
    ...
    def _request(self, method: str, path: str, **kwargs) -> Any:
        ...
        if self._api_key:
            ...
            prepared.headers[f'FTXUS-SUBACCOUNT'] = urllib.parse.quote(self._subaccount_name)
    ...
    def _sign_request(self, request: Request):
        ...
        if self._subaccount_name:
            prepared.headers['FTXUS-SUBACCOUNT'] = urllib.parse.quote(
